...
export default function QuoteSection() {
  ...
  return (
    <section
      className="w-full bg-[#0A0A0A] py-12 sm:py-16 text-white overflow-hidden border-t border-white/5"
      aria-label="Motivational quotes"
    >
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center min-h-[120px] flex items-center justify-center relative">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Quote Text */}
              <blockquote className="font-inter font-medium text-2xl sm:text-3xl md:text-4xl leading-tight mb-4 text-white tracking-tight">
                "{currentQuote.quote_text}"
              </blockquote>
              {/* Author */}
              <p className="font-inter text-sm sm:text-base text-neutral-400 uppercase tracking-widest">
                — {currentQuote.author}
              </p>
            </motion.div>
          </AnimatePresence>
