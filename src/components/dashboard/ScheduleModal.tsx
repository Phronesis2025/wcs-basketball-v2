  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center p-2 sm:p-4 z-50 overflow-y-auto pt-20 sm:pt-20">
      <div className="bg-white rounded-lg w-full max-w-2xl max-h-[calc(100vh-5rem)] sm:max-h-[calc(100vh-5rem)] flex flex-col mx-1 sm:mx-0">
        ...
        <div className="grid grid-cols-4 border-b border-gray-200 flex-shrink-0">
          {(["Game", "Practice", "Update", "Drill"] as const).map((tab) => (
            <button
              key={tab}
              onClick={() => formState.setActiveTab(tab)}
              className={`px-2 sm:px-4 py-3 text-xs sm:text-sm font-inter transition-colors ${
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      formState.setGameType(
                        e.target.value as "game" | "tournament"
                      )
                    }
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      formState.setPracticeDuration(e.target.value)
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      formState.setPracticeLocation(e.target.value)
                    }
                    placeholder="eg. Salina South Gym"
                    className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
                    required
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      formState.setPracticeComments(e.target.value)
                    }
                    className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
                    rows={3}
                  />
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      formState.setDrillYoutubeUrl(e.target.value)
                    }
                    placeholder="e.g., https://www.youtube.com/watch?v=VIDEO_ID"
                    className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    If provided, the YouTube thumbnail will be used instead of
                    the uploaded image
                  </p>
                </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            formState.setNewSkill(e.target.value)
                          }
                          ...
                          onKeyPress={(e) =>
                            e.key === "Enter" &&
                            (e.preventDefault(), formState.addSkill())
                          }
                        />
                        <button
                          type="button"
                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            formState.setNewEquipment(e.target.value)
                          }
                        ...
                        {formState.drillEquipment.map((equipment, index) => (
                          ...
                          >
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                formState.removeEquipment(equipment)
                              }
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      formState.setDrillInstructions(e.target.value)
                    }
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      formState.setDrillAdditionalInfo(e.target.value)
                    }
          ...
          <div className="flex justify-end pt-4 pb-3 sm:pt-6 sm:pb-6 px-3 sm:px-6 border-t border-gray-200 bg-white flex-shrink-0">
            <button
              type="submit"
              disabled={loading}
