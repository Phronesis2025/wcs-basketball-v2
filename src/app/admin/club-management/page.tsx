...
function ClubManagementContent() {
  ...
  return (
    <>
      <Navbar />
      <main className="relative pt-20 md:pt-32 pb-24 bg-black text-slate-300 antialiased selection:bg-blue-600 selection:text-white min-h-screen">
        ...
        <div className="relative container mx-auto px-4 py-8 z-10">
            ...
            <div className="bg-gray-800 p-1 rounded-lg">
              {(() => {
                ...
                const adminTabs = [
                  ...
                  { id: "overview", label: "Manage", icon: FaList },
                  {
                    id: "coaches-dashboard",
                    label: "Coach",
                    icon: FaBasketballBall,
                  },
                  { id: "analytics", label: "Monitor", icon: FaChartBar },
                ];
                ...
                const tabs = userRole === "admin" ? adminTabs : coachTabs;
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-gray-800/95 backdrop-blur-sm border-t border-gray-700 z-50 md:hidden safe-area-bottom">
                ...
                return tabs.map((tab) => {
                  ...
                  return (
                    <button
                      key={tab.id}
                      onClick={() => handleTabChange(tab.id)}
                      className="flex flex-col items-center justify-center gap-1 py-2 px-3 min-w-[60px] rounded-lg font-inter transition-all"
                    >
                      <IconComponent
                        className={`w-5 h-5 ${
                          activeTab === tab.id
          ...
          {/* Tab Content - Add bottom padding on mobile for fixed nav */}
                          ...
                          <div className="space-y-3">
                            {drills.length > 0 ? (
                              ...
                              <div className="text-center py-8">
                                ...
                                <p className="text-slate-500 text-sm mt-1 font-inter">
                                  Click &quot;Add Drill&quot; to create your
                                  first drill
                                </p>
                              </div>
                            )}
                            ...
                            <div className="space-y-4">
                              <div className="pb-3 border-b border-white/10">
                                ...
                                <p className="text-xs text-slate-500 mt-1 font-inter">
                                  From web_vitals table (last 30 days) -
                                  Distinct sessions
                                </p>
                                <p className="text-xs text-slate-400 mt-0.5 font-inter">
                                  Counts unique visitors based on session IDs
                                  from Core Web Vitals tracking
                                </p>
                              </div>
                              <div className="pb-3 border-b border-white/10">
                                <div className="flex justify-between items-center mb-1">
                                ...
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  <span
                                    className={`text-lg font-bold font-inter ${
                                      ...
                                      0.1
                                        ? "text-green-400"
                                        : (analyticsData?.webVitals?.cls ||
                                            0.1) < 0.25
                                        ? "text-yellow-400"
                                        : "text-red-400"
                                    }`}
                                  >
                                    {analyticsData?.webVitals?.cls?.toFixed(
                                      2
                                    ) || 0.1}
                                  </span>
                                </div>
                ...
                <div className="bg-white rounded-lg p-6 max-w-lg w-full mx-4 shadow-xl">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500 mb-6">
                      This action cannot be undone. The {deleteTarget?.type}{" "}
              ...
              <PlayerPaymentModal
                ...
                onOnHold={async (playerId: string, reason: string) => {
                  ...
                  try {
                    ...
                    toast.dismiss(loadingToast);
                    toast.error(
                      "An error occurred while updating player status"
                    );
                    throw error;
                  }
                }}
          ...
          {/* End of Tab Content wrapper with bottom padding */}
        </div>
      </main>
    </>
  );
