# Security Audit Report - January 9, 2025
...
### Changes in Version 2.10.9

**Files Modified**:
1. `src/app/layout.tsx` - Removed font preload links
2. `src/components/registration/RegistrationWizard.tsx` - Step numbering, completion logic, animation, colors
3. `src/app/admin/club-management/page.tsx` - Pending players notification, unread mentions click
4. `src/components/dashboard/MessageBoard.tsx` - Mobile zoom fix, unread mentions click
5. `src/components/dashboard/CoachProfile.tsx` - Unread mentions scroll functionality
6. `src/app/add-child/page.tsx` - Terminology updates
7. `src/app/register/page.tsx` - Terminology updates
8. `src/app/globals.css` - Step pulse animation
